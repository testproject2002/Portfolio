  ...
  return (
    <section id="education-and-experience" className="mt-20 mx-4 lg:mx-20 flex flex-col md:flex-row gap-4 md:gap-2">
      ...
      <div className="w-full md:w-[80%]">
        {/* =========== EDUCATION TITLE =========== */}
        <h4 className="text-xl dark:text-white  text-custom-navyblue mb-4 font-bold flex gap-2 items-center">
          <FaLandmark className="text-xl text-custom-green dark:text-custom-blue" />
          Education
        </h4>
              ...
              <div className="flex gap-x-3 relative group rounded-lg">
                ...
                <div className="grow p-2 pb-8">
                  ...
                  <h3 className="flex items-center gap-x-2 font-semibold text-zinc-800 dark:text-white">
                    ...
                    <div className="leading-5 text-custom-navyblue dark:text-white">
                      {edu.school}
                      {/* =========== DEGREE =========== */}
        ...
        {/* =========== CERTIFICATES TITLE =========== */}
        <h4 className="text-xl text-custom-navyblue  dark:text-white mt-6 font-bold flex gap-2 items-center">
          <PiCertificateFill className="text-2xl text-custom-green dark:text-custom-blue" />
          Certificates
        </h4>
        ...
        >
                  ...
                  <div className="hs-carousel-slide relative" key={index}>
                    ...
                    <div className="flex justify-center items-center h-full bg-gray-100 p-6 dark:bg-neutral-900">
                      <div className="hs-tooltip [--placement:bottom] inline-block">
                        <a href={cert.link} target="_blank" rel="noreferrer" className="hs-tooltip-toggle text-center text-gray-800 dark:text-white hover:text-custom-green hover:dark:text-custom-blue">
                          {/* =========== CERTIFICATE NAME =========== */}
                          <p className=" transition duration-700 px-6 font-bold  text-custom-navyblue dark:text-white">
                            {cert.title}
                          </p>
          ...
          <div className="hs-carousel-pagination flex justify-center absolute bottom-3 start-0 end-0 space-x-2">
            {user_info.certificates.map((cert, index) => {
              return (
                <span
                  className="hs-carousel-active:bg-custom-green hs-carousel-active:border-custom-blue size-3 border border-gray-400 rounded-full cursor-pointer dark:border-neutral-600 dark:hs-carousel-active:bg-white dark:hs-carousel-active:border-custom-navyblue"
                  key={index}
                ></span>
              );
            })}
      ...
      <div className="w-full">
        {/* =========== EXPERIENCE TITLE =========== */}
        <h4 className="text-xl  text-custom-navyblue dark:text-white mb-4 font-bold flex gap-2 items-center">
          <FaBuildingUser className="text-2xl text-custom-green dark:text-custom-blue" />
          Experience
        </h4>
                ...
                <div className="flex gap-x-3 relative group rounded-lg">
                  ...
                  <div className="grow p-2 pb-8">
                    ...
                    <h3 className="flex items-center gap-x-2 font-semibold text-zinc-800 dark:text-white">
                      ...
                      <div className="leading-5 dark:text-white text-custom-navyblue ">
                        {exp.company}
                        {/* =========== POSITION =========== */}
                        <p className="font-normal text-xs text-zinc-600 dark:text-zinc-400">
                          {exp.position}
                      ...
                      {exp.descriptions.map((desc, index) => {
                        return (
                          <li className="flex space-x-3" key={index}>
                            <svg
                              className="flex-shrink-0 size-4 mt-0.5 text-custom-green dark:text-custom-blue"
                              xmlns="http://www.w3.org/2000/svg"
                              width="24"
                              height="24"
                              viewBox="0 0 24 24"
